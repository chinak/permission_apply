...
- [src/app/pages/NaturalPersonList.tsx](file://src/app/pages/NaturalPersonList.tsx)
- [src/app/pages/NaturalPersonBranchList.tsx](file://src/app/pages/NaturalPersonBranchList.tsx)
- [src/app/pages/NaturalPersonSettings.tsx](file://src/app/pages/NaturalPersonSettings.tsx)
- [src/app/pages/FlowRollback.tsx](file://src/app/pages/FlowRollback.tsx)
</cite>

## 更新摘要
**变更内容**
- 新增自然人员管理相关页面路由：NaturalPersonList、NaturalPersonBranchList、NaturalPersonSettings
- 新增流程回滚功能路由：FlowRollback
- 更新了路由配置以支持新的业务模块
- 完善了面包屑导航和侧边栏导航映射
...
## 核心组件
- 路由配置：使用 createBrowserRouter 定义根路径 "/"，子路由通过 children 数组声明，包含首页、申请流程、审批、系统设置、仓库相关页面及新增的自然人员管理和流程回滚功能。
...
**更新** 新增了自然人员管理（NaturalPersonList、NaturalPersonBranchList、NaturalPersonSettings）和流程回滚（FlowRollback）相关的路由配置。
...
**更新** 新增了以下路由配置：
- `/natural-person-list` - 自然人员列表管理
- `/natural-person-branch-list` - 自然人员分支机构管理  
- `/natural-person-settings` - 自然人员设置
- `/flow-rollback` - 流程回滚功能
...
Children --> NP["natural-person-* 系列"]
Children --> FR["flow-rollback"]
...
**更新** 新增页面的接入示例：
- 自然人员管理页面：NaturalPersonList、NaturalPersonBranchList、NaturalPersonSettings
- 流程回滚页面：FlowRollback
...
PAGES --> NP["NaturalPerson* 页面"]
PAGES --> FR["FlowRollback 页面"]
```
...
**更新** 随着自然人员管理和流程回滚功能的加入，系统已经具备了更完整的企业级管理能力，为后续的功能扩展奠定了良好的基础。
