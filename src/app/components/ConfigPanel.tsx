...
export function ConfigPanel() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 bg-white p-4 rounded-lg shadow-xl border border-slate-200 text-xs w-72">
      <h3 className="font-bold mb-2 text-slate-800">状态模拟面板</h3>
